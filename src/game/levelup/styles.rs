...
pub const LEVEL_UP_MENU_STYLE: Style = {
    let mut style = Style::DEFAULT;
    style.position_type = PositionType::Absolute;
    style.width = Val::Percent(80.0);
...
pub const LEVEL_UP_MENU_TRANSFORM: Transform = {
    let mut transform = Transform::IDENTITY;
    transform.translation.z = 1000.0;
    transform
};

pub const LEVEL_UP_BUTTON_STYLE: Style = {
    let mut style = Style::DEFAULT;
...
pub const LEVEL_UP_MENU_BACKGROUND_COLOR: Color = Color::rgba(0.0, 0.0, 0.0, 0.5);
